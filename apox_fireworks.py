...
class App:
    ...
    def prepare_data(self):
        def prepare_hourly_data(diff_tage):
            ...
            for year in self.settings['years']:
                ...
                df['jahr'] = year # make sure that new year works as well
                if len(result)==0:
                    result = df
                else:
    ...
    def prepare_plot(self):
        dic_title = {'1. August': 'Feinstaub (PM10) Konzentrationen am 1. August', 'Neujahr': 'Feinstaub (PM10) Konzentrationen am Neujahr'}
...
am Silvester und am 1. August beobachten. Zwar sind die extrem hohen Werte in der Regel von kurzer Dauer, doch können sie, bei bereits erhöhter Basiskonzentration der Schadstoffe, zur Überschreitung des Tagesmittels von 50µg/m³ für pm10 führen. Dies war zum Beispiel in 2008 und 2010 mit Werten über 400µg/m³.
...
Feuerwerk abgesagt wurde, zum Beispiel in 2018 (Trockenheit-bedingt) oder im 2020/21 (Covid-19 bedingt). 

Wichtiger als die Höhe ist die Fläche unter der Kurve, d.h. wie lange die Rauchwolke über der Stadt gehangen ist: Kurze hohe Spitzen können den Tagesmittelwert weniger stark beeinflussen 
